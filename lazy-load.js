...
var observer = new IntersectionObserver((entries, observer) => {
    onIntersect(entries, observer, this);
});
	...
	function onIntersect(entry, observer, element) {
   entry.forEach((entry) => {
     if(!entry.isIntersecting || element?.renderComponent ){
       return
     }else{
       element.getDetails()
	 element.renderedComponent = true
     }
   }) 
